...
function Footer() {
    return (
        <div className="footer-container">
            <section classNamefooter-subscription>
                <p className="footer-subscription-heading">Join The Builder newsletter to check the latest amazing builds!</p>
      ...
      <section class='social-media'>
        <div class='social-media-wrap'>
          ...
          <small class='website-rights'>THE BUILDER © 2021</small>
